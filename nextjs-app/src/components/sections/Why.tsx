...
export default function Why() {
  ...
  return (
    <section ref={sectionRef} className="relative overflow-x-clip py-[var(--section-padding)]">
      ...
      <svg
        className="pointer-events-none absolute left-0 top-0 h-full w-[300px] opacity-60 max-md:hidden"
        viewBox="0 0 300 700"
        fill="none"
      >
        <path
      ...
      <svg
        className="pointer-events-none absolute right-0 top-1/4 h-[400px] w-[250px] opacity-50 max-md:hidden"
        viewBox="0 0 250 400"
        fill="none"
      >
